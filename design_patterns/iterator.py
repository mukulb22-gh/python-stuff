...
if __name__ == "__main__":
    ...
    dairy_collection.add_product(DairyProduct("Milk", "2024-03-15"))
    dairy_collection.add_product(DairyProduct("Yogurt", "2024-03-20"))
    dairy_collection.add_product(DairyProduct("Cheese", "2024-04-10"))
